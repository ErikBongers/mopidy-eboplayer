            ...
            <div id="playBar">
                ...
                <div id="buttonBar" class="flexRow">
                    ...
                    <ebo-dropdown id="btnRepeat" style="margin-left: 1em;" direction="up">
                        <ebo-option value="${"justPlay" satisfies PlaybackUserOptions}"><img src="images/icons/Repeat.svg" alt="Repeat" class="whiteIcon dropDownImage op2 middle" style="margin-block-start: -.2rem;"></ebo-option>
                        <ebo-option value="${"repeat" satisfies PlaybackUserOptions}"><img src="images/icons/Repeat.svg" alt="Repeat" class="whiteIcon dropDownImage middle" style="margin-block-start: -.2rem;"></ebo-option>
                        <ebo-option value="${"repeatSingle" satisfies PlaybackUserOptions}" ><img src="images/icons/RepeatOne.svg" alt="Repeat one" class="whiteIcon dropDownImage middle" style="margin-block-start: -.2rem;"></ebo-option>
                    </ebo-dropdown>
                </div>
            </div>
        </div>
